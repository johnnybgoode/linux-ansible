...
const PATTERNS = [
  ...
  { level: 'strict', id: 'git-push-delete', regex: /\bgit\s+push\b.+(--delete|-d)\b/, reason: 'remote delete' },
  ...
  { level: 'strict', id: 'git-config', regex: /\bgit\s+config\b/, reason: 'git config overrides author, remote settings' },
  { level: 'strict', id: 'git-remote', regex: /\bgit\s+remote\s+(rename|remove|set-(.*))\b/, reason: 'git remote changes the upstream' },
